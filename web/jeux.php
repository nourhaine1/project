            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a><i class="fa fa-angle-double-right"></i><span>Videos Educatifs</span>
...
<div class="modal fade" id="search" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="col">
          <form method="post" action="verifyAgeJeu.php" data-toggle="validator" >
            <input value ="3 ou4" name ="ageSaisie" type="text" class="form-control" placeholder="age" aria-label="First name">
  </div>
   ...
   <source src="./images/<?=$jeu['path']?>" type="video/mp4" /> 
   <source src="./images/<?=$jeu['path']?>" type="video/ogg" /> 
   <source src="./images/<?=$jeu['path']?>" type="video/webm" /> 
   <track src="sous-titre-fr.vtt" kind="subtitles" srclang="fr" label="francais">
     <p>Votre navigateur ne supporte pas l'élément vidéo.</p> 
                ...
                <h2>Pour voir des jeux il faut indiquer l'age de votre enfant !</h2>
