                ...
                <div class="col-lg-12">
                   ...
                   <p>Fill out the form below to sign up for Tivo. Already signed up? Then just <a class="white" href="log-in.html">Log In</a></p> 
                    ...
                    <div class="form-container">
                        <form  action="signup.php"  data-toggle="validator" data-focus="false" method="post">
                            ...
                            <div class="form-group">
                                <input   name="ville" type="text" class="form-control-input" id="sville" required>
                                <label class="label-control" for="spassword">Ville</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input   name="age" type="text" class="form-control-input" id="sage" required>
                                <label class="label-control" for="spassword">Age of Child</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group checkbox">
                                <input type="checkbox" name="terms" id="sterms" value="Agreed-to-Terms" required>I agree with Tivo's <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
